...
(() => {
  ...
  const I18N={
    ko:{
      ...
      q1:'어떤 비용을 줄이고 싶으신가요?', q1b:'현재 검토하려는 영역을 선택해 주세요.', q1s:'정확한 견적이 아니라, 어떤 방식으로 검토해야 하는지 판단하기 위한 원가 최적화 진단입니다.',
    ...
    ja:{
      ...
      q1:'どのコストを最適化したいですか？', q1b:'現在検討している領域を選択してください。', q1s:'正確な見積ではなく、どのような最適化検討が必要かを判断するための原価最適化診断です。',
